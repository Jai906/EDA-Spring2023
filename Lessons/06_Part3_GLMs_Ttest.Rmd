...
#----Reject null based on p-vaule from t.test----#
...
# Format as a GLM
#----- ~1 means there is no explanatory variable----#
...
#---Generating frequency plot by year---#
...
# Format as a GLM - asking if year is a predictor of ozone levels
