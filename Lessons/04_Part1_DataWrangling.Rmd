...
# Selecting for Paul Lake and Peter Lake
# Way 1 - include lakes with names Paul Lake or Peter Lake
NTL.phys.data.PeterPaul1 <- filter(NTL.phys.data, lakename == "Paul Lake" | lakename == "Peter Lake")

# Way 2 - exclude all other lakes
...
# 152 represent June 1st 305 represents nov 1st
...
# interval has specified start and end dates
# Works if data is organized by date
interval(NTL.phys.data.PeterPaul1$sampledate[1], NTL.phys.data.PeterPaul1$sampledate[21613])

# When not organized by date - better approach/works for any sized dataset
...
Don't want to do everything in the same file. Becomes very long and can get lost in the process
