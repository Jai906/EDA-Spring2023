...
```{r, fig.height = 3, fig.width = 4}
#---Remove zeros inorder to take log and remove outliers----#
PeterPaul.chem.nutrients <- filter(PeterPaul.chem.nutrients, 
                                   irradianceWater != 0 & irradianceWater < 5000)
#----log irradiance values----#
irradiance.regression2 <- lm(data = PeterPaul.chem.nutrients, 
                             log(irradianceWater) ~ depth)
